      ...
      <TradeDetailFullBox>
        ...
        <ItemContentBox>
          <ItemTitleBox>
            ...
            <ItemDetailInfoText>
              <span >판매자 <span className='sellerNick'>{nick}</span></span>
              <span>상품상태 <span  className='sellInfo'>거의 새것</span></span>
              <span>교환여부교환 <span  className='sellInfo'>불가능</span></span>
              <span>배송비 <span  className='sellInfo'>배송비 미포함</span></span>
              <span>거래지역 <span  className='sellInfo'>전국</span></span>
            </ItemDetailInfoText>
            <ButtonWrap>
